...
One of the most enduring rituals of 'academic life' is the dutiful compilation of publications—that familiar litany of books and journal articles for which one must claim responsibility. Presumably this exercise demonstrates scholarly credibility to colleagues, who will scan the accumulated citations and find reassurance in their methodical completeness. While I no longer navigate the corridors of academic institutions, I haven't entirely abandoned the habit of cataloguing my research output. The record below contains some highlights, for a longer list see [Research Gate](https://www.researchgate.net/profile/Peter-Marshall-8) and [Google Scholar](https://scholar.google.com/citations?user=6umhXIcAAAAJ&hl=en).

During my time at English Heritage & Historic England, my research centered on understanding past human behaviors and environmental conditions through scientific analysis—particularly the application of radiocarbon dating and related chronometric techniques to archaeological contexts. The work encompassed radiocarbon calibration, Bayesian statistical modeling of dates, taphonomic processes affecting organic preservation, stable isotope analysis, and the integration of multiple dating methods for robust chronological frameworks. I also explored broader questions of how environmental change influenced cultural transitions and settlement patterns in the archaeological record.

In my current role, my research output has naturally diminished compared to those more productive years. Nevertheless, my ongoing work as a scientific dating consultant continues to generate findings worthy of publication, and these contributions are gradually appearing in the relevant specialist journals .

The map below provides a spatial overview of some of the sites sites & projects I have been fortunate to have worked on.
...
-   **Finding Sites:** **Blue markers** indicate  sites or project we have been involved with. **Click on any blue marker** for links to further inf
...
leaflet() %>%
  addTiles() %>%  # Add default OpenStreetMap map tiles
    addMarkers(
    lng = -1.8262, lat = 51.1789,  # Coordinates for Stonehenge
    popup = "<strong>Stonehenge</strong><br><a href='/blog/stonehenge/index.html' target='_blank'>Read more</a>"
  ) %>%
  addMarkers(
    lng = -1.7869, lat = 51.1920,  # Coordinates for Woodhenge
    popup = "<strong>Woodhenge</strong><br><a href='/blog/woodhenge/index.html' target='_blank'>Read more</a>"
  ) %>%
  addMarkers(
    lng = -3.21499, lat = 58.99705,  # Coordinates for Ness of Brodgar
    popup = "<strong>Ness of Brodgar</strong><br><a href='/blog/ness-of-brodgar/index.html' target='_blank'>Read more</a>"
  )
```
...
::: {.altmetric-embed data-badge-popover="right" data-badge-type="1" data-doi="10.15184/aqy.2021.185" data-hide-no-mentions="true"}
:::
...
::: {.altmetric-embed data-badge-popover="right" data-badge-type="1" data-doi="10.15184/aqy.2017.218" data-hide-no-mentions="true"}
:::
...
::: {.altmetric-embed data-badge-popover="right" data-badge-type="1" data-doi="10.1016/j.jasrep.2018.06.008" data-hide-no-mentions="true"}
:::
...
::: {.altmetric-embed data-badge-popover="right" data-badge-type="1" data-doi="10.15184/aqy.2017.140" data-hide-no-mentions="true"}
:::
